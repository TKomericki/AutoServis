SET NAMES utf8;
replace into user(user_id, email, password, original_password, name, last_name, active, broj_Telefona, role) values(0, 'admin@admin.hr', '$2a$10$byvHamNquEgFfTaXJiL/9.sCPtQel5zh0nf8vlghOal5TR.quiJTe', 'admin', 'Admin', 'Admin', 1, '0990000000', 'ADMIN'); 
